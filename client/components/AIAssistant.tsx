...
export default function AIAssistant() {
  ...
  const aiSuggestions = [
    {
      icon: Code,
      text: "Generate code from current nodes",
      category: "generate",
    },
    { icon: Bug, text: "Debug the node connection error", category: "debug" },
    {
      icon: Zap,
      text: "Optimize the data processing pipeline",
      category: "optimize",
    },
    {
      icon: Lightbulb,
      text: "Suggest improvements for the algorithm",
      category: "chat",
    },
  ];
        ...
        <Tabs value={activeTab} className="h-full flex flex-col">
          ...
          <TabsContent value="debug" className="flex-1 m-0 p-4">
            <div className="space-y-4">
              <div className="glass-panel rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm text-matrix-purple-200">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      Warning: Function node "Process Data" has no error
                      handling
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <div className="glass-panel rounded-lg p-4">
                <div className="text-sm font-medium text-matrix-gold-300 mb-2">
                  Suggested Fixes
                </div>
                <div className="space-y-2 text-sm text-matrix-purple-200">
                ...
                <Button
                  size="sm"
                  className="mt-3 bg-gradient-to-r from-matrix-gold-500 to-matrix-gold-600 hover:from-matrix-gold-600 hover:to-matrix-gold-700 text-matrix-dark"
                >
            ...
            <div className="space-y-4">
              <div className="glass-panel rounded-lg p-4">
                ...
                <div className="text-sm text-matrix-purple-200 mb-3">
                  Based on your current node configuration, I can generate
                  optimized code in multiple languages.
                </div>
                <div className="flex gap-2">
                  <Button
                    size="sm"
                    variant="outline"
                    className="border-matrix-purple-600/50"
                  >
                    Python
                  </Button>
                  <Button
              ...
              <div className="glass-panel rounded-lg p-4">
                ...
                <div className="space-y-2">
                  <Button
                    variant="ghost"
                    className="w-full justify-start text-sm hover:bg-matrix-purple-700/30"
                  >
                    <Code className="h-4 w-4 mr-2" />
          ...
          {aiSuggestions.map((suggestion, index) => {
            ...
            return (
              <Button
                ...
                variant="ghost"
                onClick={() =>
                  handleSuggestionClick(suggestion.text, suggestion.category)
                }
