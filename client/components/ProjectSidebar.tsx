    ...
    children: [
      {
        ...
        children: [
          ...
          { id: '4', name: 'data_processor.py', type: 'file', language: 'python' },
      ...
      },
      {
        ...
        children: [
          ...
          { id: '8', name: 'processing_nodes.json', type: 'file', language: 'json' },
          { id: '9', name: 'output_nodes.json', type: 'file', language: 'json' },
        ]
      },
      {
        id: '10',
...
export default function ProjectSidebar() {
    ...
    return (
      <div key={node.id}>
        ...
        >
          ...
          {node.language && (
            <Badge variant="outline" className="ml-auto text-xs h-4 border-matrix-purple-600/50">
              {node.language}
            </Badge>
          )}
        </div>
  ...
  const filteredFiles = searchTerm 
    ? projectFiles.filter(node => node.name.toLowerCase().includes(searchTerm.toLowerCase()))
    : projectFiles;
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="h-12 border-b border-matrix-purple-600/30 flex items-center justify-between px-4">
        <h2 className="text-sm font-medium text-matrix-gold-300">Project Explorer</h2>
          ...
          <TabsContent value="files" className="h-full m-0">
            <ScrollArea className="h-full px-4 py-2">
              ...
              <div className="mt-6 pt-4 border-t border-matrix-purple-600/30">
                <div className="text-xs text-matrix-purple-400 mb-2">Project Statistics</div>
            ...
            <ScrollArea className="h-full px-4 py-2">
              ...
              <div className="mt-6 pt-4 border-t border-matrix-purple-600/30">
                <div className="flex items-center justify-between mb-3">
                  <div className="text-xs text-matrix-purple-400">Custom Nodes</div>
                ...
                <div className="glass-panel rounded-lg p-3 text-center text-xs text-matrix-purple-400">
                  No custom nodes yet. Create your first custom node to extend the IDE functionality.
                </div>
              </div>
            </ScrollArea>
          </TabsContent>
