    ...
    <div className="h-full flex flex-col">
      ...
      <div className="h-12 border-b border-matrix-purple-600/30 flex items-center justify-between px-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-matrix-gold-300">Settings & Preferences</span>
        </div>
        <div className="flex items-center gap-2">
            ...
            <TabsContent value="general" className="m-0 space-y-6">
              ...
              <div className="glass-panel rounded-lg p-4">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="font-medium text-matrix-gold-300">Appearance</span>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-matrix-purple-200">Font Size</div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-matrix-purple-200">Node Snap to Grid</div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-matrix-purple-200">Show Minimap</div>
              ...
              <div className="glass-panel rounded-lg p-4">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="font-medium text-matrix-gold-300">Performance</span>
                </div>
                
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-matrix-purple-200">Max Nodes</div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-matrix-purple-200">Render Optimization</div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-matrix-purple-200">Memory Limit (MB)</div>
            ...
            <TabsContent value="editor" className="m-0 space-y-6">
              <div className="glass-panel rounded-lg p-4">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="font-medium text-matrix-gold-300">Code Editor</span>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-matrix-purple-200">Auto Save</div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-matrix-purple-200">Live Preview</div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-matrix-purple-200">Word Wrap</div>
            ...
            <TabsContent value="ai" className="m-0 space-y-6">
              <div className="glass-panel rounded-lg p-4">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="font-medium text-matrix-gold-300">AI Assistant</span>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-matrix-purple-200">Enable AI</div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Select value={settings.aiModel} onValueChange={(value) => updateSetting('aiModel', value)}>
                      ...
                      <SelectContent>
                        <SelectItem value="local-gpt-neo">GPT-Neo (Local)</SelectItem>
                        <SelectItem value="local-codegen">CodeGen (Local)</SelectItem>
                        <SelectItem value="local-llama">LLaMA (Local)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-matrix-purple-200">AI Suggestions</div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-matrix-purple-200">AI Auto Complete</div>
            ...
            <TabsContent value="export" className="m-0 space-y-6">
              <div className="glass-panel rounded-lg p-4">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="font-medium text-matrix-gold-300">Export & Deployment</span>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-matrix-purple-200">Include Comments</div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-matrix-purple-200">Minify Code</div>
              ...
              <div className="glass-panel rounded-lg p-4">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="font-medium text-matrix-gold-300">Deployment Targets</span>
                </div>
                
                <div className="grid grid-cols-2 gap-2">
                  <Button variant="outline" className="border-matrix-purple-600/50 hover:bg-matrix-purple-700/30">
