    ...
    <div className="h-screen w-full flex flex-col bg-gradient-to-br from-matrix-dark via-matrix-purple-900 to-matrix-dark text-foreground overflow-hidden">
      ...
      <header className="h-16 glass-dark border-b border-matrix-purple-600/30 flex items-center justify-between px-6 z-50">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Action Buttons */}
          <Button size="sm" variant="outline" className="border-matrix-purple-600/50 hover:bg-matrix-purple-700/50">
            <Save className="h-4 w-4 mr-2" />
            Save
          </Button>
          <Button size="sm" className="bg-gradient-to-r from-matrix-gold-500 to-matrix-gold-600 hover:from-matrix-gold-600 hover:to-matrix-gold-700 text-matrix-dark">
      ...
      <footer className="h-8 glass-dark border-t border-matrix-purple-600/30 flex items-center justify-between px-6 text-sm">
        <div className="flex items-center gap-4">
          <Badge variant="outline" className="border-matrix-gold-400/50 text-matrix-gold-300 text-xs">
            Open Source
          </Badge>
          <span className="text-matrix-purple-300">Offline-First AI IDE</span>
        </div>
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="sm" className="h-6 text-xs hover:bg-matrix-purple-700/30">
            <Github className="h-3 w-3 mr-1" />
            GitHub
          </Button>
          <span className="text-matrix-purple-400">Ready for deployment on Windows, Linux, macOS</span>
        </div>
      </footer>
    </div>
  );
